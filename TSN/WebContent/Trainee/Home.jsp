                  ...
                  <div id="register">
                    ...
                    <div class="divValidate">
                     ...
                     <div class="divValidate">
                      ...
                      <div class="divValidate">
                      <label>Email Address <span class="text-danger" id="pqr">*</span></label>
...
$(document).ready(function(){	
	...
	jQuery.validator.addMethod("email", function (value, element) {
	 ...
	 jQuery.validator.addMethod("validpassword", function (value, element) {
		     //return this.optional(element) || /^[a-z]+$/i.test(value);       /^(?=.*[0-9])(?=.*[!@#$%^&*])[a-zA-Z0-9!@#$%^&*]{6,16}$/
		     return this.optional(element) || /(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z])(?=.*[!@#$%^&*]).{6,}$/i.test(value);
		 }, "Input must contain at least one digit and special characters and alphanumeric letter and be at least six characters long.");
