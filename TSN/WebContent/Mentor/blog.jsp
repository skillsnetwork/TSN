...
<link rel="stylesheet" href="plugins/toastr-master/bootstrap-combined.min.css">
    ...
    <div class="uou-block-1a blog">
      <div class="container">
        ...
        <ul class="authentication">
         ...
         <c:forEach items="${sessionScope.UserName}" var="i">${i.s1}</c:forEach> 
