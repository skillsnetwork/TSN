				...
				<div class="col-md-12">
					...
					<div class="portlet box blue-hoki">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Registered User Details
							</div>
							<div class="tools">
							</div>
						</div>
						<div class="portlet-body">
							...
							<tr>
								...
								<td>${i.email}</td>
							<td>
								<a class="btn btn-success"  href="<%=request.getContextPath()%>/RegistrationController?flag=edit&ID=${i.email}">EDIT</a>
							</td>
							<td>
								
								<a class="btn btn-success"  href="<%=request.getContextPath()%>/RegistrationController?flag=delete&ID=${i.email}">DELETE</a>
							</td>
							</tr>
							</c:forEach>
							</tbody>
