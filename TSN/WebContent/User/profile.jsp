...
<!-- Mirrored from www.keenthemes.com/preview/metronic/theme/templates/admin4/form_editable.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 01 Oct 2015 10:03:07 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
<meta charset="utf-8"/>
<title>Skills Network| Form Stuff - Form X-editable</title>
								...
								<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="input-group">
											...
											<input type="text" name="emailAddress" value="${i.email }" readonly="readonly" class="form-control" placeholder="Email Address" required="required">
										</div>
									</div>
									...
									<div class="input-icon">
										...
										<input type="text" name="since" class="form-control date-picker" size="14" placeholder="Select Date" value="" required="required">
									...
									<div class="input-icon">
										...
										<input type="email" name="companyName" class="form-control"  placeholder="Company Name" required="required">
										</div>
									</div>
									</div>
									<div class="form-group col-md-4">
									...
									<div class="input-icon">
										...
										<input type="email" name="email" class="form-control"  placeholder="Current Position" required="required">
										</div>
									</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="input-icon">
										<input type="text" name="departmentName" class="form-control" placeholder="Department" required="required">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="input-icon">
										<input type="text" name="birthDate" class="form-control date-picker" size="14" placeholder="Branch Address" required="required">
										</div>
									</div>
