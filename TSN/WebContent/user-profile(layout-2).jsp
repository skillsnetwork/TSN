        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="container">
              ...
              <form action="<%=request.getContextPath()%>/ProfileController?flag=popup&ID=" method="post">
                <ul class="row">
                  <li class="col-xs-6">
...
<!--               <li><a data-toggle="tab" href="#blog-post-tabs">Mentor</a></li> -->
    ...
    <ul class="dropdown-menu">
      ...
      <li><a style="background:none !important;" href="#">Hiring Manager</a></li>
      <li><a style="background:none !important;" href="#">Recruiters</a></li>
      <li><a style="background:none !important;" href="#">Monitoring</a></li>
      <li><a style="background:none !important;" href="#">Trainers</a></li>
      <li><a style="background:none !important;" href="#">Trainee</a></li>
    </ul>
  </li>
            </ul>
          </div>
              ...
              <div id="profile" class="tab-pane fade in active">
                <div class="row">
                  <div class="col-md-12">
                    <div class="profile-main">
                      ...
                      <div class="profile-in">
						...
						<div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
							...
							<img src="${i.filePath}" alt="No Image Available" />
						</div>
						<div class="fileinput-preview fileinput-exists thumbnail" style="width: 200px; height: 150px;max-width: 1200px; max-height: 2150px;">
						</div>
						<div>
						<p id="pic_error2" style="display:none; color:#FF0000;">Max file size should be 500KB.</p>
					...
					<button id="btnphotoupload" class="btn default" value="submit" >Submit</button>
...
//binds to onchange event of your input field
        $('#picture').bind('change', function () {
            if ($('#btnphotoupload').attr('disabled', false)) {
                $('#btnphotoupload').attr('disabled', true);
            }
...
// 	alert(picsize);
            ...
            if (a === 1) {
                $('#btnphotoupload').attr('disabled', false);
            }
...
//     btnRegister.disabled=true;
 ...
 // alert("sending");
  xmlhttp.open("get", "${pageContext.request.contextPath}/UrlEncoder?ID="+email,true);
  xmlhttp.send();
